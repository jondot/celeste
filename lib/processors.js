...
const createMarkdownProcessor = opts => (0, _unified.default)().use(_remarkParse.default).use((0, _brokenLinks.default)(opts)).use((0, _fetchStars.default)(opts)).use(_remarkStringify.default, {
  bullet: '*',
  listItemIndent: 1
